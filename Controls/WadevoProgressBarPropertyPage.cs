...
public sealed class WadevoProgressBarPropertyPage : UserControl
{
    private readonly FlowLayoutPanel _layout = new();

    public event EventHandler<ProgressBarPropertyChangedEventArgs>? ProgressBarChanged;

    public WadevoProgressBarPropertyPage()
    {
        Dock = DockStyle.Fill;
        ...
        AddToggleRow("Show Progress Bar", true);
        AddNumericRow("Height", 6, 1, 40);
        AddNumericRow("Radius", 6, 0, 40);
        AddNumericRow("Opacity", 100, 0, 100);
        AddColorRow("Track Color", WadevoTheme.Colors.Panel);
        AddColorRow("Fill Color", WadevoTheme.Colors.Accent);
        AddToggleRow("Animated Fill", true);
    }
    ...
    private void AddNumericRow(string label, decimal value, decimal min, decimal max)
    {
        ...
        {
            ProgressBarChanged?.Invoke(this, new ProgressBarPropertyChangedEventArgs(label, numericBox.Value));
        };
    ...
    private void AddToggleRow(string label, bool value)
    {
        ...
        checkBox.CheckedChanged += (_, _) =>
        {
            ...
            ProgressBarChanged?.Invoke(this, new ProgressBarPropertyChangedEventArgs(label, checkBox.Checked));
        };
    ...
    private void AddColorRow(string label, Color value)
    {
        ...
        void OpenPicker()
        {
            ...
            ProgressBarChanged?.Invoke(this, new ProgressBarPropertyChangedEventArgs(label, dialog.Color));
        }
...
public sealed class ProgressBarPropertyChangedEventArgs : EventArgs
{
    public ProgressBarPropertyChangedEventArgs(string propertyName, object value)
    {
