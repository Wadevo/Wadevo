...
public sealed class BlazeConnectionStore
{
    private const string FolderName = "Wadevo";
    private const string DefaultFileName = "blaze-connection.dat";
    ...
    private static readonly byte[] Entropy = Encoding.UTF8.GetBytes("Wadevo.BlazeConnection.v1");
    ...
    public BlazeConnectionStore(string fileName = DefaultFileName)
    {
    ...
    public void Load(BlazeConnectionState state)
    {
        try
        {
            ...
            BlazeConnectionState? saved = JsonSerializer.Deserialize<BlazeConnectionState>(json, JsonOptions);
            ...
            state.ClientSecret = saved.ClientSecret;
    ...
    [SupportedOSPlatform("windows")]
    public void Save(BlazeConnectionState state)
    {
        try
        {
